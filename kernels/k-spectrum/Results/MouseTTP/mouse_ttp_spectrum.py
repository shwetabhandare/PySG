...
#three_utr_mouse_ttp_file = '/projects/debra/workspace/Data/TTP/Mus/BlackSheer/TTP_Blacksheer_3UTR_CompleteData.txt'
...
def run_three_utr_spectrum_kernel(three_utr_mouse_ttp_file, k1, k2, posLen, negLen):
	print "=== Three UTR, k-mer  length: 5 ===\n"
	print k1, k2, posLen, negLen
	## HuR binders - 3utr : pos: 275, neg: 286
	#three_utr_five_spectrum_data = get_spectrum_data(three_utr_mouse_ttp_file, 21, None, 495, 413, True)
	if k2 == 0:
		k2 = None
	three_utr_five_spectrum_data = get_spectrum_data(three_utr_mouse_ttp_file, k1, k2, posLen, negLen, True)
	print three_utr_five_spectrum_data

	r1 = run_svm(three_utr_five_spectrum_data, 5, 1, 1)
	print " ===== RESULTS ======"
	print_results(r1, 'mouse_ttp_three_utr_9_spectrum.csv');
...
three_utr_mouse_ttp_file = sys.argv[1];
k1 = int(sys.argv[2])
k2 = int(sys.argv[3])
posLen = int(sys.argv[4])
negLen = int(sys.argv[5])

run_three_utr_spectrum_kernel(three_utr_mouse_ttp_file, k1, k2, posLen, negLen)
