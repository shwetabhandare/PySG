...
three_utr_random_combined_file = '/projects/debra/workspace/Data/HuR/Kishore2011-HuR_CLIP-Seq/Combined_Human_Seq/VD_3UTR_Random_combined.txt'
...
def run_three_utr_spectrum_kernel():
	...
	#three_utr_five_spectrum_data = get_spectrum_data(three_utr_combined_file, 5, None, 275, 286, True)

	## HuR binders (random neg genes) - 3utr : pos: 274, neg: 290
	#three_utr_five_spectrum_data = get_spectrum_data(three_utr_combined_file, 5, None, 274, 290, True)
	## HuR binders (random neg genes) - 3utr : pos: 274, neg: 2469
	three_utr_five_spectrum_data = get_spectrum_data(three_utr_random_combined_file, 5, None, 275, 2469, True)
	...
	## HuR binders - 3utr : pos: 275, neg: 286
	#three_utr_seven_spectrum_data = get_spectrum_data(three_utr_combined_file, 7, None, 275, 286, True)
	## HuR binders (random neg genes) - 3utr : pos: 274, neg: 290
	#three_utr_seven_spectrum_data = get_spectrum_data(three_utr_combined_file, 7, None, 274, 290, True)
	## HuR binders (random neg genes) - 3utr : pos: 274, neg: 2469
